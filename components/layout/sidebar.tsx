...
import { BarChart3, Bot, BellRing, CreditCard, LinkIcon, PieChart, Users, Zap, Shield, LogOut } from "lucide-react"
...
export function Sidebar({ className, onNavigate }: SidebarProps = {}) {
  ...
  const navigationItems = user?.role === "admin" ? [...navigation, ...adminNavigation] : navigation
      ...
      <div className="flex flex-col flex-grow pt-5 overflow-y-auto bg-card border-r border-border">
        ...
        <div className="flex items-center flex-shrink-0 px-4">
          <div className="flex items-center">
            ...
            <span className="ml-2 text-xl font-bold text-foreground">Nexarion AI</span>
          </div>
        </div>
